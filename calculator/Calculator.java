...
public class Calculator implements CalculatorConstants {
    ...
    while (true) {
      ...
      if (jj_2_5(2)) {
        ...
        throw new ParseException();
                  ...
                  {if (true) return round( a, mPresission );}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public double unary() throws ParseException {
    ...
    if (jj_2_11(2)) {
      ...
      a = element();
                                  a = Math.sin( mIsRadians ? a : Math.toRadians( a ) );
    } else if (jj_2_17(2)) {
      jj_consume_token(COS);
      a = element();
                                  a = Math.cos( mIsRadians ? a : Math.toRadians( a ) );
    } else if (jj_2_18(2)) {
      jj_consume_token(TAN);
      a = element();
                                  a = Math.tan( mIsRadians ? a : Math.toRadians( a ) );
    } else if (jj_2_19(2)) {
      jj_consume_token(ASIN);
      a = element();
                                  a = Math.asin( mIsRadians ? a : Math.toRadians( a ) );
    } else if (jj_2_20(2)) {
      jj_consume_token(ACOS);
      a = element();
                                  a = Math.acos( mIsRadians ? a : Math.toRadians( a ) );
    } else if (jj_2_21(2)) {
      jj_consume_token(ATAN);
      a = element();
                                  a = Math.atan( mIsRadians ? a : Math.toRadians( a ) );
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  static final public double number() throws ParseException, NumberFormatException {
        Token t;
    if (jj_2_24(2)) {
  ...
  static private boolean jj_3_26() {
    if (jj_scan_token(HLFLOAT)) return true;
    return false;
  }
